...
export default function PasswordOptions ({ options }) {
  return (
    <div className={styles.passwordOptions}>
      <Slider label={options.charLength.label} name={options.charLength.name} min={options.charLength.min} max={options.charLength.max} value={options.charLength.currentValue} onChange={options.charLength.onChange} />
